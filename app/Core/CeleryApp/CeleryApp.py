...
from app.Core.Console import import_submodules
from app.Core.Logging import setup_logging
from app.Core.Registry import collect_beat_schedule, import_all_tasks
...
def _discover_modules(sender: Celery, **_: Any) -> None:
    ...
    """
    import_all_tasks()
    import_submodules("app.Core.Mail")  # tasks de correo del framework (mail.send) para el worker
