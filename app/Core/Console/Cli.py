...
`from app.Core.Console.Cli import app; app()`. Aquí vive la lógica: descubre los
...
def serve(
    ...
    uvicorn.run("app.Core.Http.Http:create_app", factory=True, host=host, port=port, reload=reload)
...
import_submodules("app.Core.Console.Commands")
import_submodules("app.Console.Commands")
